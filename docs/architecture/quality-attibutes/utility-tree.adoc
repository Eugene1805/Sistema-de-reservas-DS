...
| Desempeño | Grado en que un sistema o componente cumple sus funciones designadas dentro de unas limitaciones determinadas, tales como velocidad, precisión o uso de la memoria. +
 _(ISO/IEC/IEEE 24765:2017 Systems and software engineering-Vocabulary)_ | El sistema debe ser capaz de soportar alta concurrencia sin dobles cobros o dobles reservas.
...
_(ISO/IEC 25010:2023, Systems and software engineering--Systems and software Quality Requirements and Evaluation (SQuaRE)--Product quality model, 3.5.2)_ | El sistema debe estar disponible en tiempo real para los clientes para maximizar la ocupación.
...
_(ISO/IEC/IEEE 24765:2017 Systems and software engineering-Vocabulary)_ | El sistema debe ser capaz de ejecutarse en ambientes web y mó viles para ampliar los canales de venta.
...
_(ISO/IEC 25010:2023, Systems and software engineering--Systems and software Quality Requirements and Evaluation (SQuaRE)--Product quality model, 3.5)_ | El sistema debe ser capaz de soportar picos de tráfico que puedan generar latencias elevadas.
|===
