...
| CU-23 | Registrar habitación | Gerente | Permite dar de alta habitaciones individuales en un hotel. | Disponibilidad
| CU-24 | Consultar habitación | Gerente | Permite consultar información de una habitación registrada. | Rendimiento
| CU-25 | Actualizar habitación | Gerente | Permite modificar los datos de una habitación. | Disponibilidad
| CU-26 | Dar de baja habitación | Gerente | Permite eliminar una habitación registrada. | Seguridad
...
| CU-29 | Consultar huésped | Recepcionista | Permite consultar información de huéspedes registrados. | Rendimiento
...
| CU-33 | Registrar recepcionista | Gerente | Permite dar de alta a un recepcionista. | Seguridad
| CU-34 | Consultar recepcionistas | Gerente | Permite consultar información de recepcionistas. | Rendimiento
| CU-35 | Dar de baja recepcionista | Gerente | Permite eliminar el registro de un recepcionista. | Seguridad
|===
